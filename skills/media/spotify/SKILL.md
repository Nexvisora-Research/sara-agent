...
Control the user's Spotify account via the sara Spotify toolset (7 tools). Setup guide: https://sara-agent.nousresearch.com/docs/user-guide/features/spotify
