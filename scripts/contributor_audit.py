...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^sara\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "noreply@nexvisoraresearch.com",
    "cursoragent@cursor.com",
    "sara@nexvisoraresearch.com",
    "sara-audit@example.com",
    "sara@habibilabs.dev",
    "omx@oh-my-codex.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "nexvisoraResearch/sara-agent",
                "--state", "merged",
