...
VERSION_FILE = REPO_ROOT / "sara_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "annguyennexvisora@users.noreply.github.com": "annguyennexvisora",
    "32201324+simpolism@users.noreply.github.com": "simpolism",
    "simpolism@gmail.com": "simpolism",
    "jake@nexvisoraresearch.com": "simpolism",
    ...
    "annguyennexvisora@users.noreply.github.com": "annguyennexvisora",
    "285874597+annguyennexvisora@users.noreply.github.com": "annguyennexvisora",
    ...
    "teknium@nexvisoraresearch.com": "teknium1",
    ...
    "274096618+sara-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "mind-dragon@nexvisora.research": "Mind-Dragon",
    ...
    "shannon@nexvisoraresearch.com": "shannonsands",
    ...
    "sara@nexvisoraresearch.com": "nexvisoraResearch",
    ...
    "sara@nexvisorahq.ai": "benbarclay",
    ...
    "ben@nexvisoraresearch.com": "benbarclay",
    ...
    "emozilla@nexvisoraresearch.com": "emozilla",
    ...
    "jonny@nexvisoraresearch.com": "yoniebans",
    "jake@nexvisoraresearch.com": "simpolism",
    ...
    "sara@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    # v0.16.0 additions
    "teknium@nexvisora.dev": "teknium1",
    ...
    "github@nadyasara.anonaddy.com": "ruangraung",  # PR #42308
    ...
    "nexvisoraeman666@gmail.com": "nexvisoraeman666",  # PR #19088
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (sara_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (sara_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: sara-eval community link)
    ...
    "saraagent26@gmail.com": "saraagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+saraagent26@users.noreply.github.com": "saraagent26",
    ...
    "clement@nexvisoraresearch.com": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
    ...
    "vigo@sara": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "ethie@nexvisora": "ethernet8023",  # PR #29342 (TUI clipboard copy on linux/wayland)
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local sara runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level sara_HOME state files)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live sara
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"sara-agent[acp]=={semver}"
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "sara@nexvisoraresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/nexvisoraResearch/sara-agent",
    ...
    lines.append(f"# sara Agent v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for sara Agent. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="sara Agent Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  sara Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"sara Agent v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"sara Agent v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'sara Agent v{new_version} ({calver_date})' "
