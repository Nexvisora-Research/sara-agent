#!/usr/bin/env python3
"""Build the sara Skills Index — a centralized JSON catalog of all skills.
...
`sara skills search/install` can use it without hitting the GitHub API.
...
# Ensure sara_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building sara Skills Index...", flush=True)
