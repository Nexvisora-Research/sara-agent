...
DEFAULT_DATASETS = [
    "nexvisoraResearch/swe-terminus-agent-glm-kimi-minimax",
    "nexvisoraResearch/sara-agent-megascience-sft1",
    "nexvisoraResearch/sara-Agent-Thinking-GLM-4.7-SFT2",
    "nexvisoraResearch/sara-Agent-Thinking-GLM-4.7-SFT1",
    "nexvisoraResearch/terminal-tasks-glm-sara-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "nexvisoraResearch/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload nexvisoraResearch/{output_name} {final_output}")
