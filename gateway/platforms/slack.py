...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        ...
        tokens_file = get_sara_home() / "slack_tokens.json"
        ...
        try:
            ...
            # /model work directly without /sara prefix). A single regex
            ...
            # manifest (see `sara slack manifest`). In Socket Mode, Slack
            ...
            from sara_cli.commands import slack_native_slashes
            import re as _re
            ...
            if _slash_names:
                ...
                _slash_pattern = _re.compile(r"^/sara$")

            @self._app.command(_slash_pattern)
            async def handle_sara_command(ack, command):
    ...
    def _dm_top_level_threads_as_sessions(self) -> bool:
        ...
        own sara session — matching the per-thread behavior channels already
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "sara_approve_once",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Allow Session"},
                            "action_id": "sara_approve_session",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Allow"},
                            "action_id": "sara_approve_always",
                            "value": session_key,
                        },
                        {
                            "type": "button",
                    ...
                    "elements": [
                        {
                            ...
                            "style": "primary",
                            "action_id": "sara_confirm_once",
                            "value": value,
                        },
                        {
                            "type": "button",
                            "text": {"type": "plain_text", "text": "Always Approve"},
                            "action_id": "sara_confirm_always",
                            "value": value,
                        },
                        {
                            "type": "button",
    ...
    async def _handle_slash_confirm_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "sara_confirm_once": "once",
            "sara_confirm_always": "always",
            "sara_confirm_cancel": "cancel",
        }
    ...
    async def _handle_approval_action(self, ack, body, action) -> None:
        ...
        choice_map = {
            "sara_approve_once": "once",
            "sara_approve_session": "session",
            "sara_approve_always": "always",
            "sara_deny": "deny",
        }
    ...
    async def _handle_slash_command(self, command: dict) -> None:
        ...
        The legacy ``/sara <subcommand> [args]`` form is preserved for
        backward compatibility with older workspace manifests and for users
        who want a single entry point for free-form questions (``/sara
        ...
        if slash_name in ("sara", ""):
            # Legacy /sara <subcommand> [args] routing + free-form questions.
            # Empty slash_name falls into this branch for backward compat
            # with any caller that didn't populate command["command"].
            from sara_cli.commands import slack_subcommand_map
        ...
        # "Running /cmd…" ack shown by handle_sara_command).
        # Only stash for COMMAND events (text starts with "/") — free-form
        # questions via "/sara <question>" must produce public replies so
