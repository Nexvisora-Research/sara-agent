...
Config: ~/.sara/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.sara/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_sara_home()`` helper (sara_HOME-aware and
...
RULES_FILE = get_sara_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_sara_home() / "feishu_comment_pairing.json"
