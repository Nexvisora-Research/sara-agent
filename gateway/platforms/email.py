"""
Email platform adapter for the sara gateway.

Allows users to interact with sara by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "sara Agent")
        ...
        msg_id = f"<sara-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
