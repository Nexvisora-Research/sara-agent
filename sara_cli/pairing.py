...
Usage:
    sara pairing list              # Show all pending + approved users
    sara pairing approve <platform> <code>  # Approve a pairing code
    sara pairing revoke <platform> <user_id> # Revoke user access
    sara pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle sara pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: sara pairing {list|approve|revoke|clear-pending}")
        print("Run 'sara pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'sara pairing list' to see pending codes.\n")
