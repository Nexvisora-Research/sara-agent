"""sara CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.sara/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "sara Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ sara "       # Response box header label
...
.. code-block:: python
    ...
    from sara_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "sara Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.sara/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic sara gold/kawaii (the current look)
...
Drop a YAML file in ``~/.sara/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces sara_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces sara_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Modern sara — calm cyan, warm coral, soft slate",
        "colors": {
            "banner_border": "#2DD4BF",
            "banner_title": "#E6EDF3",
            ...
            "prompt": "#E6EDF3",
            "input_rule": "#2DD4BF",
            "response_border": "#7DD3FC",
            "status_bar_bg": "#101820",
            "status_bar_text": "#E6EDF3",
            "status_bar_strong": "#7DD3FC",
            "status_bar_dim": "#64748B",
            "status_bar_good": "#63D0A6",
            "status_bar_warn": "#F78C6C",
            "status_bar_bad": "#FF9F6E",
        ...
        "branding": {
            ...
            "welcome": "Welcome to sara Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ sara ",
            "prompt_symbol": "❯",
