"""
Skills configuration for sara Agent.
`sara skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.sara/config.yaml under:
...
from sara_cli.config import cfg_get, load_config, save_config
from sara_cli.colors import Colors, color
from sara_cli.platforms import PLATFORMS as _PLATFORMS
