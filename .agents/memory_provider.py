...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - sara_home (str): The active sara_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.sara``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "sara").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'sara memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], sara_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'sara memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``sara_home`` is the active sara_HOME directory path.
