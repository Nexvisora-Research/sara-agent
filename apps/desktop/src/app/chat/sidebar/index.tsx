...
import { type AppView, ARTIFACTS_ROUTE, MEMORY_ROUTE, MESSAGING_ROUTE, SKILLS_ROUTE } from '../../routes'
...
const SIDEBAR_NAV: SidebarNavItem[] = [
  ...
  { id: 'memory', label: '', icon: props => <Codicon name="database" {...props} />, route: MEMORY_ROUTE }
]
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('Sara:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('Sara:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
