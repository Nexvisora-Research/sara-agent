        ...
        <>
          <a
            ...
            onClick={event => {
              ...
              void window.SaraDesktop?.openExternal(error.url)
            }}
          >
...
export function PreviewPane({
  ...
  const restartServer = useCallback(async () => {
    ...
    // "Ask Sara to restart the server" looked like it did nothing —
  ...
  useEffect(() => {
    if (
      ...
      !window.SaraDesktop?.watchPreviewFile ||
      !window.SaraDesktop?.onPreviewFileChanged
    ) {
      return
    }
    ...
    const unsubscribe = window.SaraDesktop.onPreviewFileChanged(payload => {
    ...
    void window.SaraDesktop
      ...
      .then(watch => {
        if (!active) {
          void window.SaraDesktop?.stopPreviewFileWatch?.(watch.id)
    ...
    return () => {
      ...
      if (watchId) {
        void window.SaraDesktop?.stopPreviewFileWatch?.(watchId)
      }
    }
  ...
  useEffect(() => {
    ...
    webview.setAttribute('partition', 'persist:Sara-preview')
