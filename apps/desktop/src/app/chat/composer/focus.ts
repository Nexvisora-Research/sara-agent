 ...
 *
 * `dispatch` defers to a macrotask so synchronexvisora click/keydown handlers
...
const FOCUS_EVENT = 'Sara:composer-focus'
const INSERT_EVENT = 'Sara:composer-insert'
const INSERT_REFS_EVENT = 'Sara:composer-insert-refs'
