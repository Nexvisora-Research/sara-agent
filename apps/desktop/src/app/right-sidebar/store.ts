...
const TAKEOVER_KEY = 'Sara.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Sara can't clear via the API — the user
 *  sees exactly what runs instead of Sara silently deleting their creds. */
