...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/Sara'
...
// / Program Files), which buried any files Sara wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.SaraDesktop` is
    ...
    const settings = window.SaraDesktop?.settings
