import type { SaraConfigRecord, ToolsetInfo } from '@/types/Sara'
...
export function getNested(obj: SaraConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: SaraConfigRecord, path: string, value: unknown): SaraConfigRecord {
...
function personalityOptions(config: SaraConfigRecord): string[] {
