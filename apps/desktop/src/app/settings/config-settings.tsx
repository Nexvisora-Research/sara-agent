...
import type { ConfigFieldSchema, SaraConfigRecord } from '@/types/Sara'
...
export function ConfigSettings({
  ...
  const [_defaults, setDefaults] = useState<SaraConfigRecord | null>(null)
  ...
  useEffect(() => {
    let cancelled = false
    Promise.all([getSaraConfigRecord(), getSaraConfigDefaults(), getSaraConfigSchema()])
      .then(([c, d, s]) => {
        if (cancelled) {
          return
        }
  ...
  const updateConfig = (next: SaraConfigRecord) => {
