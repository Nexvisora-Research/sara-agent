...
import type { MemoryProviderConfig } from '@/types/Sara'
  ...
  const fields: MemoryProviderConfig['fields'] = [
    {
      ...
      kind: 'select',
      value: 'cloud',
      description: 'How Sara connects to Hindsight.',
      placeholder: '',
      is_set: true,
      options: [
    ...
    { key: 'bank_id', label: 'Bank ID', kind: 'text', value: 'Sara', description: '', placeholder: '', is_set: true, options: [] },
    {
      key: 'recall_budget',
      label: 'Recall budget',
      kind: 'select',
