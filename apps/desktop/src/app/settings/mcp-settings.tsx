...
import { getSaraConfigRecord, type SaraGateway, saveSaraConfig } from '@/Sara'
...
function getServers(config: SaraConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveSaraConfig(nextConfig)
