...
describe('useSessionStateCache — per-session turn timer', () => {
  beforeEach(() => {
    ...
    // want it synchronexvisora so the global mirror is observable immediately. The
    ...
    // assignment doesn't overwrite the null the synchronexvisora callback just set —
    ...
    // test-only artifact of firing synchronexvisoraly).
