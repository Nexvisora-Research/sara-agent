...
describe('usePreviewRouting', () => {
  ...
  it('does not infer previews from assistant prose', async () => {
    ...
    expect(window.SaraDesktop.normalizePreviewTarget).not.toHaveBeenCalled()
  })
  ...
  it('registers structured tool-result preview targets', async () => {
    ...
    expect(window.localStorage.getItem('Sara.desktop.sessionPreviews.v1')).toContain('./dist/index.html')
  })
