...
// hairline `--stroke-nexvisora` paired with the soft `--shadow-nexvisora` float.
export const HUD_SURFACE = 'rounded-xl border border-(--stroke-nexvisora) bg-(--ui-chat-bubble-background) shadow-nexvisora'
