...
export const en: Translations = {
  ...
  boot: {
    ready: 'Sara Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Sara settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingSaraDesktop: 'Starting Sara Desktop…'
    },
    errors: {
      backgroundExited: 'Sara background process exited.',
      backgroundExitedDuringStartup: 'Sara background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Sara backend is older than this desktop build and may not work correctly. Update to align them.',
    updateSara: 'Update Sara',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Sara Desktop.',
    ...
    native: {
      ...
      inputBody: 'Sara is waiting for your response.',
      turnDoneTitle: 'Sara finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Sara defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Sara is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Sara asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Sara was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Sara follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Sara checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Sara configuration...',
    ...
    gateway: {
      ...
      intro:
        'Sara Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Sara backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset Sara_DESKTOP_REMOTE_URL and Sara_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Sara backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Sara backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /Sara.',
      ...
      restartingMessage: 'Sara Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Sara ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Sara runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
    ...
    toolsets: {
      ...
      ready: 'Ready',
      nexvisoraIncluded: 'Included with a nexvisora subscription — sign in to nexvisora Portal to activate.',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Sara desktop' },
      skills: { title: 'Skills & Tools', detail: 'Enable skills, toolsets, and providers' },
      messaging: { title: 'Messaging', detail: 'Set up Telegram, Slack, Discord, and more' },
      artifacts: { title: 'Artifacts', detail: 'Browse generated outputs' },
      memory: { title: 'Memory', detail: 'View and manage persistent memory' }
    },
    sectionEntries: {
    ...
    SaraActiveSessions: (version, count) => `Sara ${version} · Active sessions ${count}`,
    ...
    nexvisoraage: period => `No usage in the last ${period} days.`,
    retry: 'Retry',
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@Sara:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Sara environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Sara will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Sara...',
    placeholderReconnecting: 'Reconnecting to Sara…',
    ...
    attachUrlDesc: 'Sara will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Sara can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Sara is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Sara backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Sara from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Sara will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Sara updater will take over in its own window and reopen Sara when it’s done.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Sara reconnects automatically when it’s back.',
    applyingClose: 'Sara will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Sara needs a one-time install',
    ...
    settingUpTitle: 'Setting up Sara Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Sara CLI or desktop instance is running. Stop any running Sara instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Sara installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Sara Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Sara is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Sara…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Sara',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Sara at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Sara connects automatically',
      loopback: 'Opens your browser to sign in — Sara connects automatically',
    ...
    authorizeThere: 'Authorize Sara there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Sara there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid nexvisora subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Sara inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Sara will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Sara is restarting...',
      askRestart: 'Ask Sara to restart the server',
      lookingRestart: taskId => `Sara is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Sara is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Sara finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Sara could not restart the server.',
      stillWorking:
        'Sara is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Sara is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Sara gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.Sara/config.yaml). Sara won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Sara needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Sara needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Sara Desktop to use Save Image.',
    restartToSaveImages: 'Restart Sara Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `Sara gateway` running?'
    }
  },
