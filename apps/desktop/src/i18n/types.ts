...
export type Locale = 'en' | 'zh' | 'zh-hant' | 'ja' | 'ko' | 'fr' | 'de' | 'es'
...
export interface Translations {
  ...
  commandCenter: {
    ...
    nav: Record<'newChat' | 'settings' | 'skills' | 'messaging' | 'artifacts' | 'memory', { title: string; detail: string }>
    ...
    SaraActiveSessions: (version: string, count: number) => string
    ...
    loadingUsage: string
    nexvisoraage: (period: number) => string
    retry: string
    dailyTokens: string
    input: string
    output: string
