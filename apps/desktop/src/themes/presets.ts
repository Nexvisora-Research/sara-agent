...
const nexvisora_BLUE = '#0053FD'
const PSYCHE_BLUE = '#1540B1'
const PSYCHE_WARM = '#FFE6CB'

const nexvisoraTint = (pct: number) => `color-mix(in srgb, ${nexvisora_BLUE} ${pct}%, #FFFFFF)`
const nexvisoraTintTransparent = (pct: number) => `color-mix(in srgb, ${nexvisora_BLUE} ${pct}%, transparent)`

/**
 * nexvisora — canonical Sara desktop identity. The palette keeps the current
 * glass geometry neutral, then lets the old bb/gui blue and psyche cream
 * return as accent seeds.
 */
export const nexvisoraTheme: DesktopTheme = {
  name: 'nexvisora',
  label: 'nexvisora',
  description: 'Glass neutrals with nexvisora blue accents',
  colors: {
    background: '#F8FAFF',
    foreground: '#17171A',
    card: '#FFFFFF',
    cardForeground: '#17171A',
    muted: nexvisoraTint(5),
    mutedForeground: '#666678',
    popover: '#FFFFFF',
    popoverForeground: '#17171A',
    primary: nexvisora_BLUE,
    primaryForeground: '#FCFCFC',
    secondary: nexvisoraTint(7),
    secondaryForeground: '#242432',
    accent: nexvisoraTint(10),
    accentForeground: '#202030',
    border: nexvisoraTintTransparent(22),
    input: nexvisoraTintTransparent(30),
    ring: nexvisora_BLUE,
    midground: nexvisora_BLUE,
    composerRing: nexvisora_BLUE,
    destructive: '#C72E4D',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#F3F7FF',
    sidebarBorder: nexvisoraTintTransparent(18),
    userBubble: nexvisoraTint(6),
    userBubbleBorder: nexvisoraTintTransparent(24)
  },
  darkColors: {
    background: '#0D2F86',
...
export const DEFAULT_SKIN_NAME = 'nexvisora'
