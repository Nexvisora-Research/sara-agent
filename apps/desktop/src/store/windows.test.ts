...
const desktopWindow = window as unknown as { SaraDesktop?: Window['SaraDesktop'] }
const initialSaraDesktop = desktopWindow.SaraDesktop
...
function installBridge(
  openSessionWindow?: Window['SaraDesktop']['openSessionWindow'],
  openNewSessionWindow?: Window['SaraDesktop']['openNewSessionWindow']
) {
  desktopWindow.SaraDesktop = {
    ...(openSessionWindow ? { openSessionWindow } : {}),
    ...(openNewSessionWindow ? { openNewSessionWindow } : {})
  } as unknown as Window['SaraDesktop']
}
...
afterEach(() => {
  if (initialSaraDesktop) {
    desktopWindow.SaraDesktop = initialSaraDesktop
  } else {
    delete desktopWindow.SaraDesktop
  }
})
