...
import type { ModelOptionProvider, ModelOptionsResponse, ModelPricing } from '@/types/Sara'
...
export function ModelPickerDialog({
  ...
  // the `Sara model` CLI picker, which shows the curated list verbatim.
...
function ProviderHeading({ provider }: { provider: ModelOptionProvider }) {
  ...
  // free_tier is only set for nexvisora. true → "Free tier", false → "Pro".
  const tierBadge =
