 ...
 *
 * A public install can end up with `origin=git@github.com:nexvisoraResearch/Sara-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/nexvisoraResearch/Sara-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nexvisoraresearch/Sara-agent'
