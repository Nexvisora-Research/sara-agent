...
``_check_spotify_available()`` — when the user has not run ``sara auth
spotify``, the tools remain registered (so they appear in ``sara
...
The Spotify auth flow (``sara auth spotify``), CLI plumbing, and docs
