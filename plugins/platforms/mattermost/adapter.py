...
required — uses aiohttp which is already a Sara dependency.
...
def interactive_setup() -> None:
    ...
    ``Sara_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # Sara_cli/setup.py::_setup_mattermost function.
