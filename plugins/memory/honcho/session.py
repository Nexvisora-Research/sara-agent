...
class HonchoSessionManager:
    ...
    Runs alongside sara' existing SQLite state and file-based memory,
    ...
    def get_or_create(self, key: str) -> HonchoSession:
        ...
        assistant_peer_id = self._sanitize_id(
            self._config.ai_peer if self._config else "sara-assistant"
        )
    ...
    def _flush_session(self, session: HonchoSession) -> bool:
        """Internal: write unsynced messages to Honcho synchronexvisoraly."""
    ...
    def save(self, session: HonchoSession) -> None:
        ...
        write_frequency modes:
          ...
          "turn"    — flush synchronexvisoraly every turn
    ...
    def flush_all(self) -> None:
        ...
        # Drain async queue synchronexvisoraly if it exists
        if self._async_queue is not None:
    ...
    def dialectic_query(
        ...
        try:
            ...
            # Apply sara-side char cap before caching
    ...
    def prefetch_context(self, session_key: str, user_message: str | None = None) -> None:
        ...
        a synchroNexvisoraHTTP round-trip blocking every response.
        """
        def _run():
    ...
    def get_prefetch_context(self, session_key: str, user_message: str | None = None) -> dict[str, str]:
        ...
        # Also fetch AI peer's own representation so sara knows itself.
        try:
    ...
    def migrate_memory_files(self, session_key: str, memory_dir: str) -> bool:
        ...
        Args:
            ...
            memory_dir: Path to the memories directory (~/.sara/memories/).
