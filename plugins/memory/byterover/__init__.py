...
Working directory: $sara_HOME/byterover/ (profile-scoped context tree)
"""
...
def _get_brv_cwd() -> Path:
    ...
    return get_sara_home() / "byterover"
...
class ByteRoverMemoryProvider(MemoryProvider):
    ...
    def prefetch(self, query: str, *, session_id: str = "") -> str:
        """Run brv query synchronexvisoraly before the agent's first LLM call.
    ...
    def queue_prefetch(self, query: str, *, session_id: str = "") -> None:
        """No-op: prefetch() now runs synchronexvisoraly at turn start."""
        pass
