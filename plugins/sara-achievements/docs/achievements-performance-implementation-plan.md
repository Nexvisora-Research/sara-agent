# sara Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.sara/plugins/sara-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.sara/plugins/sara-achievements/scan_checkpoint.json`.
