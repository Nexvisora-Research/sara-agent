# sara Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.sara/plugins/sara-achievements/state.json` (existing unlock state)
  - `~/.sara/plugins/sara-achievements/scan_snapshot.json` (new)
  - `~/.sara/plugins/sara-achievements/scan_checkpoint.json` (new)
