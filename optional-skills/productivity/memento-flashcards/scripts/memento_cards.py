...
Data file: $sara_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_sara_HOME = Path(os.environ.get("sara_HOME", Path.home() / ".sara"))
DATA_DIR = _sara_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
