---
name: sara-atropos-environments
description: Build, test, and debug sara Agent RL environments for Atropos training. Covers the saraAgentBaseEnv interface, reward functions, agent loop integration, evaluation with tools, wandb logging, and the three CLI modes (serve/process/evaluate). Use when creating, reviewing, or fixing RL environments in the sara-agent repo.
version: 1.1.0
author: sara Agent
license: MIT
metadata:
