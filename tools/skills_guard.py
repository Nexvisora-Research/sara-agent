...
Trust levels:
  - builtin:   Ships with sara. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.sara/\.env|\~/\.sara/\.env',
     "sara_env_access", "critical", "exfiltration",
     "directly references sara secrets file"),
    ...
    (r'\.sara/config\.yaml|\.sara/SOUL\.md',
     "sara_config_mod", "critical", "persistence",
     "references sara configuration files directly"),
