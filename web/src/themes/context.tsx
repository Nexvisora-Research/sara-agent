...
const STORAGE_KEY = "sara-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `sara_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "sara-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-sara-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-sara-theme-font", "true");
