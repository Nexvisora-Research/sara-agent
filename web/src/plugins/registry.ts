 ...
 *
 * Plugins call window.__sara_PLUGINS__.register(name, Component)
...
import { Tabs, TabsList, TabsTrigger } from "@nexvisora-research/ui/ui/components/tabs";
...
export function exposePluginSDK() {
  window.__sara_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__sara_PLUGIN_SDK__ = {
