...
export const en: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update sara plugins (`sara plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.sara/plugins/?",
    removeHint: "Only user-installed plugins under ~/.sara/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.sara/skills/",
