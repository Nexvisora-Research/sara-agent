...
import { SelectionSwitcher } from "@/components/ui/selection-switcher";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="sara-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="sara-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({ onNavigate }: { onNavigate: () => void }) {
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updatesara,
      runningLabel: t.status.updatingsara,
      spin: false,
    },
  ];
