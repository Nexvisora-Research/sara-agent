  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the sara Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use sara &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with sara?{' '}
        <a
          href="https://github.com/NexvisoraResearch/sara-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/NexvisoraResearch" target="_blank" rel="noopener noreferrer">
          Nexvisora ResearchDiscord
        </a>{' '}
