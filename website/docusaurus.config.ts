...
const config: Config = {
  ...
  organizationName: 'NexvisoraResearch',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/NexvisoraResearch/sara-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/sara-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://discord.gg/NexvisoraResearch',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/NexvisoraResearch' },
            { label: 'GitHub Discussions', href: 'https://github.com/NexvisoraResearch/sara-agent/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https://github.com/NexvisoraResearch/sara-agent' },
            { label: 'Nexvisora Research ', href: 'https://NexvisoraResearch.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://NexvisoraResearch.com">Nexvisora Research </a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
