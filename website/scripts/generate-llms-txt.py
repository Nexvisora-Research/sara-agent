#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the sara docs site.
...
Both publish at:
  https://sara-agent.NexvisoraResearch.com/docs/llms.txt
  https://sara-agent.NexvisoraResearch.com/docs/llms-full.txt
...
SITE_BASE = "https://sara-agent.NexvisoraResearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use sara as a Python Library", None),
        ("guides/use-mcp-with-sara", "Use MCP with sara", None),
        ("guides/use-voice-mode-with-sara", "Use Voice Mode with sara", None),
        ("guides/use-soul-with-sara", "Use SOUL.md with sara", None),
        ("guides/build-a-sara-plugin", "Build a sara Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with sara"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# sara Agent")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Nexvisora Research . A terminal-native "
        ...
        "backends. Works with NexvisoraPortal, OpenRouter, OpenAI, Anthropic, Google, or any "
        "OpenAI-compatible endpoint."
    )
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/NexvisoraResearch/"
        "sara-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NexvisoraResearch/sara-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# sara Agent — Full Documentation\n",
        (
            "This file is the entire sara Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using sara, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://sara-agent.NexvisoraResearch.com/docs\n",
        "Short index: https://sara-agent.NexvisoraResearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
