...
| | |
|---|---|
| Source | Optional — install with `sara skills install official/productivity/canvas` |
...
4. Name the token (e.g., "sara Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.sara/.env`:
...
```bash
CANVAS="python $sara_HOME/skills/productivity/canvas/scripts/canvas_api.py"
