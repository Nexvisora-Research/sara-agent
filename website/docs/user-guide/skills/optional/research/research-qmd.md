...
| | |
|---|---|
| Source | Optional — install with `sara skills install official/research/qmd` |
...
sara Agent via the native MCP client. This is the preferred
...
Then configure sara Agent to connect via HTTP:
