...
| | |
|---|---|
| Source | Optional — install with `sara skills install official/health/neuroskill-bci` |
...
Connect sara to a running [NeuroSkill](https://neuroskill.com/) instance to read
