...
| | |
|---|---|
| Source | Optional — install with `sara skills install official/autonomous-ai-agents/blackbox` |
| Path | `optional-skills/autonomous-ai-agents/blackbox` |
| Version | `1.0.0` |
| Author | sara Agent (Nexvisora Research ) |
| License | MIT |
| Tags | `Coding-Agent`, `Blackbox`, `Multi-Agent`, `Judge`, `Multi-Model` |
| Related skills | [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`codex`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`sara-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-sara-agent) |
...
Delegate coding tasks to [Blackbox AI](https://www.blackbox.ai/) via the sara terminal. Blackbox is a multi-model coding agent CLI that dispatches tasks to multiple LLMs (Claude, Codex, Gemini, Blackbox Pro) and uses a judge to select the best implementation.
