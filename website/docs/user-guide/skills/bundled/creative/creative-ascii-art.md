...
```bash
python3 -m pyfiglet "sara" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=sara&font=Slant" | boxes -d stone
```
