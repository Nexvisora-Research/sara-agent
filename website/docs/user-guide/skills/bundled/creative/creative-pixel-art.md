...
```python
import sys
sys.path.insert(0, "/home/teknium/.sara/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.sara/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — sara installs package this)
