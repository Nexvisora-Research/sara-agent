...
| Version | `1.1.0` |
| Author | sara Agent (adapted from obra/superpowers) |
| License | MIT |
...
> **For sara:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use sara tools to understand the project:
