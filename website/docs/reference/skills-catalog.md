...
| [`sara-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-sara-agent) | Configure, extend, or contribute to sara Agent. | `autonomous-ai-agents/sara-agent` |
...
| [`kanban-worker`](/docs/user-guide/skills/bundled/devops/devops-kanban-worker) | Pitfalls, examples, and edge cases for sara Kanban workers. The lifecycle itself is auto-injected into every worker's system prompt as KANBAN_GUIDANCE (from agent/prompt_builder.py); this skill is what you load when you want deeper det... | `devops/kanban-worker` |
...
| Skill | Description | Path |
|-------|-------------|------|
| [`debugging-sara-tui-commands`](/docs/user-guide/skills/bundled/software-development/software-development-debugging-sara-tui-commands) | Debug sara TUI slash commands: Python, gateway, Ink UI. | `software-development/debugging-sara-tui-commands` |
| [`sara-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-sara-agent-skill-authoring) | Author in-repo SKILL.md: frontmatter, validator, structure. | `software-development/sara-agent-skill-authoring` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Plan mode: write markdown plan to .sara/plans/, no exec. | `software-development/plan` |
