...
import type { ScrollBoxHandle } from '@sara/ink'
import { evictInkCaches } from '@sara/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.sara_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
